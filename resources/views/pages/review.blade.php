...
<section class="section_reviews_container">
	<div class="reviews_container">
		<h1>Reviews From Our Patient.</h1><br>
            ...
            <textarea name="comment" cols="50" rows="2.5" placeholder="Add to review.." ></textarea></p>
            <p><input type="submit" class="button_submit" value="Publication">
            <input type="reset" class="button_reset" value="Сlear"></p>
            </form>
